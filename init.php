...
class_alias(Winter\Blog\Updates\CategoriesAddNestedFields::class, RainLab\Blog\Updates\CategoriesAddNestedFields::class);
class_alias(Winter\Blog\Updates\UpdateTimestampsNullable::class, RainLab\Blog\Updates\UpdateTimestampsNullable::class);
class_alias(Winter\Blog\Updates\CreatePostsTable::class, RainLab\Blog\Updates\CreatePostsTable::class);
class_alias(Winter\Blog\Updates\SeedAllTables::class, RainLab\Blog\Updates\SeedAllTables::class);
class_alias(Winter\Blog\Updates\CreateCategoriesTable::class, RainLab\Blog\Updates\CreateCategoriesTable::class);
class_alias(Winter\Blog\Updates\PostsAddMetadata::class, RainLab\Blog\Updates\PostsAddMetadata::class);
