...
return [
    ...
    'blog' => [
        ...
        'tab_general' => 'Général',
        'use_rich_editor_label' => 'Utiliser l\'éditeur enrichi pour le contenu du blog',
        'use_rich_editor_comment' => 'Par défaut, les articles de blog sont rédigés en Markdown. Si cette option est activée, l\'éditeur devient un éditeur HTML (WYSIWYG).',
    ],
    'posts' => [
    ...
    'post' => [
        ...
        'preview_page' => 'Page de prévisualisation',
        'preview_page_comment' => 'La page qui doit être utilisée lors de la prévisualisation de l\'article',
    ...
    'settings' => [
        ...
        'posts_except_post_validation' => 'Les exceptions doivent être un seul slug ou ID, ou une liste de slugs et d\'IDs séparés par des virgules.',
        'posts_except_categories' => 'Catégories exceptées',
        'posts_except_categories_description' => 'Saisir une liste de slugs de catégories séparées par des virgules ou une variable contenant une telle liste de catégories à exclure.',
        'posts_except_categories_validation' => 'Les exceptions de catégorie doivent être un seul slug de catégorie ou une liste de slugs séparés par des virgules.',
